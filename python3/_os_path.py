...
def main():
	...
	#	print time.strftime("%d/%m/%Y %H:%M:%S",time.localtime(os.path.getatime(sys.argv[0])))
	#except( os.error ):
	...
	#	print time.strftime("%d/%m/%Y %H:%M:%S",time.localtime(os.path.getmtime(sys.argv[0])))
	#except:
	#	print "illegal access"
	...
	#	print time.strftime("%d/%m/%Y %H:%M:%S",time.localtime(os.path.getctime(sys.argv[0])))
	#except:
	#	print "illegal access"
